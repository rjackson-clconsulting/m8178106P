...
#if   defined ( __CC_ARM )
  #define __ASM            __asm                                      /*!< asm keyuint16_t for ARM Compiler          */
  #define __INLINE         __inline                                   /*!< inline keyuint16_t for ARM Compiler       */

#elif defined ( __ICCARM__ )
  #define __ASM           __asm                                       /*!< asm keyuint16_t for IAR Compiler          */
  #define __INLINE        inline                                      /*!< inline keyuint16_t for IAR Compiler. Only available in High optimization mode! */

#elif defined ( __GNUC__ )
  #define __ASM            __asm                                      /*!< asm keyuint16_t for GNU Compiler          */
  #define __INLINE         inline                                     /*!< inline keyuint16_t for GNU Compiler       */

#elif defined ( __TASKING__ )
  #define __ASM            __asm                                      /*!< asm keyuint16_t for TASKING Compiler      */
  #define __INLINE         inline                                     /*!< inline keyuint16_t for TASKING Compiler   */
...
typedef union
{
  ...
  uint32_t w;                            /*!< Type      used for uint16_t access                  */
} APSR_Type;
...
/* Interrupt Priorities are uint16_t accessible only under ARMv6M                   */
/* The following MACROS handle generation of the register offset and uint8_t masks */
