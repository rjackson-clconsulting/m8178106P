 ...
 typedef struct stc_gpio_epfr02_field
{
    union {
        ...
        struct {
            __IO uint32_t RTO10    : 2;
            __IO uint32_t RTO11    : 2;
            __IO uint32_t RTO12    : 2;
            __IO uint32_t RTO13    : 2;
            __IO uint32_t RTO14    : 2;
            __IO uint32_t RTO15    : 2;
            uint32_t NOTDEF1       : 1;
            uint32_t RESERVED2     : 3;
            __IO uint32_t DTTI1S   : 2;
            __IO uint32_t FRCK1S   : 2;
            __IO uint32_t IC10     : 3;
            __IO uint32_t IC11     : 3;
            __IO uint32_t IC12     : 3;
            __IO uint32_t IC13     : 3;
        };
    };
 ...
 typedef struct stc_gpio_epfr07_field
{
    union {
        ...
        struct{
                ...
                __IO uint32_t SIN0  : 2;
                __IO uint32_t SOT0  : 2;
                __IO uint32_t SCK0  : 2;
                __IO uint32_t SIN1  : 2;
                __IO uint32_t SOT1  : 2;
                __IO uint32_t SCK1  : 2;
                __IO uint32_t SIN2  : 2;
                __IO uint32_t SOT2  : 2;
                __IO uint32_t SCK2  : 2;
                __IO uint32_t SIN3  : 2;
                __IO uint32_t SOT3  : 2;
                __IO uint32_t SCK3  : 2;
        };
    };
...
typedef struct stc_gpio_epfr08_field
{
    union {
        ...
        struct {
            __IO uint32_t RTS4     : 2;
            __IO uint32_t CTS4     : 2;
            __IO uint32_t SIN4     : 2;
            __IO uint32_t SOT4     : 2;
            __IO uint32_t SCK4     : 2;
            __IO uint32_t SIN5     : 2;
            __IO uint32_t SOT5     : 2;
            __IO uint32_t SCK5     : 2;
            __IO uint32_t SIN6     : 2;
            __IO uint32_t SOT6     : 2;
            __IO uint32_t SCK6     : 2;
            __IO uint32_t SIN7     : 2;
            __IO uint32_t SOT7     : 2;
            __IO uint32_t SCK7     : 2;
        };
    };
...
typedef struct stc_gpio_epfr11_field
{
    union {
        struct {
        __IO uint32_t MALE         : 1;
        __IO uint32_t MCS0XE       : 1;
        __IO uint32_t MAD01_07     : 7;
        __IO uint32_t MADATA       : 16;
        __IO uint32_t RELOC        : 1;
...
} stc_gpio_epfr11_field_t;							// questo è in piu rispetto al mb9b500r.h
...
} stc_gpio_epfr12_field_t;							// questo è in piu rispetto al mb9b500r.h
...
} stc_gpio_epfr13_field_t;								// questo è in piu rispetto al mb9b500r.h
...
} stc_gpio_epfr14_field_t;								// questo è in piu rispetto al mb9b500r.h
...
typedef struct stc_gpio_epfr15_field
{
    union {
        ...
        struct {
            __IO uint32_t EINT16   : 2;
            __IO uint32_t EINT17   : 2;
            __IO uint32_t EINT18   : 2;
            __IO uint32_t EINT19   : 2;
            __IO uint32_t EINT20   : 2;
            __IO uint32_t EINT21   : 2;
            __IO uint32_t EINT22   : 2;
            __IO uint32_t EINT23   : 2;
            __IO uint32_t EINT24   : 2;
            __IO uint32_t EINT25   : 2;
            __IO uint32_t EINT26   : 2;
            __IO uint32_t EINT27   : 2;
            __IO uint32_t EINT28   : 2;
            __IO uint32_t EINT29   : 2;
            __IO uint32_t EINT30   : 2;
            __IO uint32_t EINT31   : 2;
        };
    };
} stc_gpio_epfr15_field_t;								// questo è in piu rispetto al mb9b500r.h
...
typedef struct stc_gpio_pzr0_field
{
  ...
  __IO uint32_t P8         : 1;
  __IO uint32_t P9         : 1;
} stc_gpio_pzr0_field_t;								// questo è in piu rispetto al mb9b500r.h
...
typedef struct stc_gpio_pzr1_field
{
  ...
  __IO uint32_t PE         : 1;
  __IO uint32_t PF         : 1;
} stc_gpio_pzr1_field_t;								// questo è in piu rispetto al mb9b500r.h
...
typedef struct stc_gpio_pzr2_field
{
  ...
  __IO uint32_t P8         : 1;
  __IO uint32_t P9         : 1;
} stc_gpio_pzr2_field_t;								// questo è in piu rispetto al mb9b500r.h
...
typedef struct stc_gpio_pzr3_field
{
  ...
  __IO uint32_t PE         : 1;
  __IO uint32_t PF         : 1;
} stc_gpio_pzr3_field_t;								// questo è in piu rispetto al mb9b500r.h
...
typedef struct stc_gpio_pzr4_field
{
  ...
  __IO uint32_t PD         : 1;
  __IO uint32_t PE         : 1;
} stc_gpio_pzr4_field_t;								// questo è in piu rispetto al mb9b500r.h
...
typedef struct stc_gpio_pzr5_field
{
  ...
  __IO uint32_t PC         : 1;
  __IO uint32_t PD         : 1;
} stc_gpio_pzr5_field_t;								// questo è in piu rispetto al mb9b500r.h
...
typedef struct stc_gpio_pzr6_field
{
  ...
  __IO uint32_t P1         : 1;
  __IO uint32_t P2         : 1;
} stc_gpio_pzr6_field_t;								// questo è in piu rispetto al mb9b500r.h
...
typedef struct stc_gpio_pzr7_field
{
  ...
  __IO uint32_t PE         : 1;
  __IO uint32_t PF         : 1;
} stc_gpio_pzr7_field_t;								// questo è in piu rispetto al mb9b500r.h
...
typedef struct stc_gpio_pzr8_field
{
  ...
  __IO uint32_t P2         : 1;
  __IO uint32_t P3         : 1;
} stc_gpio_pzr8_field_t;								// questo è in piu rispetto al mb9b500r.h
...
typedef struct stc_gpio_pzr9_field
{
  ...
  __IO uint32_t P4         : 1;
  __IO uint32_t P5         : 1;
} stc_gpio_pzr9_field_t;								// questo è in piu rispetto al mb9b500r.h
...
typedef struct stc_gpio_pzra_field
{
  ...
  __IO uint32_t P4         : 1;
  __IO uint32_t P5         : 1;
} stc_gpio_pzra_field_t;								// questo è in piu rispetto al mb9b500r.h
...
typedef struct stc_gpio_pzrb_field
{
  ...
  __IO uint32_t P6         : 1;
  __IO uint32_t P7         : 1;
} stc_gpio_pzrb_field_t;								// questo è in piu rispetto al mb9b500r.h
...
typedef struct stc_gpio_pzrc_field
{
  ...
  __IO uint32_t PE         : 1;
  __IO uint32_t PF         : 1;
} stc_gpio_pzrc_field_t;								// questo è in piu rispetto al mb9b500r.h
...
typedef struct stc_gpio_pzrd_field
{
  ...
  __IO uint32_t P2         : 1;
  __IO uint32_t P3         : 1;
} stc_gpio_pzrd_field_t;								// questo è in piu rispetto al mb9b500r.h
...
typedef struct stc_gpio_pzre_field
{
  ...
  __IO uint32_t P2         : 1;
  __IO uint32_t P3         : 1;
} stc_gpio_pzre_field_t;								// questo è in piu rispetto al mb9b500r.h
...
typedef struct stc_gpio_pzrf_field
{
  ...
  __IO uint32_t P5         : 1;
  __IO uint32_t P6         : 1;
} stc_gpio_pzrf_field_t;								// questo è in piu rispetto al mb9b500r.h
...
typedef struct
{
  ...
  union {
	...
	stc_gpio_epfr11_field_t EPFR11_f;				// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t EPFR12;
	stc_gpio_epfr12_field_t EPFR12_f;				// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t EPFR13;
	stc_gpio_epfr13_field_t EPFR13_f;				// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t EPFR14;
	stc_gpio_epfr14_field_t EPFR14_f;				// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t EPFR15;
	stc_gpio_epfr15_field_t EPFR15_f;				// questo è in piu rispetto al mb9b500r.h
  };
        uint8_t RESERVED8[192];
  union {
    __IO uint32_t PZR0;
	stc_gpio_pzr0_field_t PZR0_f;					// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t PZR1;
	stc_gpio_pzr1_field_t PZR1_f;					// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t PZR2;
	stc_gpio_pzr2_field_t PZR2_f;					// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t PZR3;
	stc_gpio_pzr3_field_t PZR3_f;					// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t PZR4;
	stc_gpio_pzr4_field_t PZR4_f;					// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t PZR5;
	stc_gpio_pzr5_field_t PZR5_f;					// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t PZR6;
	stc_gpio_pzr6_field_t PZR6_f;					// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t PZR7;
	stc_gpio_pzr7_field_t PZR7_f;					// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t PZR8;
	stc_gpio_pzr8_field_t PZR8_f;					// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t PZR9;
	stc_gpio_pzr9_field_t PZR9_f;					// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t PZRA;
	stc_gpio_pzra_field_t PZRA_f;					// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t PZRB;
	stc_gpio_pzrb_field_t PZRB_f;					// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t PZRC;
	stc_gpio_pzrc_field_t PZRC_f;					// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t PZRD;
	stc_gpio_pzrd_field_t PZRD_f;					// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t PZRE;
	stc_gpio_pzre_field_t PZRE_f;					// questo è in piu rispetto al mb9b500r.h
  };
  union {
    __IO uint32_t PZRF;
	stc_gpio_pzrf_field_t PZRF_f;					// questo è in piu rispetto al mb9b500r.h
  };
...
typedef struct stc_mfs03_uart_smr_field
{
  ...
  __IO  uint8_t SBL        : 1;
  __IO  uint8_t WUCR       : 1;
        uint8_t RESERVED5        : 1;							// nel mb9b500r.h c erano 3 bit per MD
        uint8_t RESERVED6        : 1;
        uint8_t RESERVED7        : 1;
...
typedef struct stc_mfs47_uart_smr_field
{
  ...
  __IO  uint8_t SBL        : 1;
  __IO  uint8_t WUCR       : 1;
        uint8_t RESERVED2  : 1;							// nel mb9b500r.h c erano 3 bit per MD
        uint8_t RESERVED3  : 1;
        uint8_t RESERVED4  : 1;
...
typedef struct stc_mfs47_uart_fcr_field
{
  ...
  __IO uint16_t FRIE       : 1;							// nel mb9b500r.h si chiamava FRIIE
  __IO uint16_t FLSTE      : 1;
       uint16_t RESERVED2  : 1;
  __IO uint16_t FTST0      : 1;							// questo è in piu rispetto al mb9b500r.h
  __IO uint16_t FTST1      : 1;							// questo è in piu rispetto al mb9b500r.h
...
typedef struct stc_mfs47_uart_fcr1_field
{
  ...
  __IO  uint8_t FTIE       : 1;
  __IO  uint8_t FDRQ       : 1;
  __IO  uint8_t FRIE       : 1;							// nel mb9b500r.h si chiamava FRIIE
...
typedef struct stc_mfs47_csio_smr_field
{
  ...
  __IO  uint8_t WUCR       : 1;
        uint8_t MD0        : 1;							// nel mb9b500r.h c erano 3 bit per MD
        uint8_t MD1        : 1;
        uint8_t MD2        : 1;
