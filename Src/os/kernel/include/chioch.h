 ...
 * @details This class represents a generic, uint8_t-wide, I/O channel. This class
...
/**
 * @brief   Channel blocking uint8_t write.
 * @details This function writes a uint8_t value to a channel. If the channel
 *          is not ready to accept data then the calling thread is suspended.
 *
 * @param[in] ip        pointer to a @p BaseChannel or derived class
 * @param[in] b         the uint8_t value to be written to the channel
...
/**
 * @brief   Channel blocking uint8_t write with timeout.
 * @details This function writes a uint8_t value to a channel. If the channel
 *          is not ready to accept data then the calling thread is suspended.
 *
 * @param[in] ip        pointer to a @p BaseChannel or derived class
...
/**
 * @brief   Channel blocking uint8_t read.
 * @details This function reads a uint8_t value from a channel. If the data
 *          is not available then the calling thread is suspended.
 *
 * @param[in] ip        pointer to a @p BaseChannel or derived class
 * @return              A uint8_t value from the queue.
...
/**
 * @brief   Channel blocking uint8_t read with timeout.
 * @details This function reads a uint8_t value from a channel. If the data
 *          is not available then the calling thread is suspended.
 *
 * @param[in] ip        pointer to a @p BaseChannel or derived class
 ...
 *                      - @a TIME_INFINITE no timeout.
 *                      .
 * @return              The number of uint8_ts transferred.
 *
 * @api
 */
