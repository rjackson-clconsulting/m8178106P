 ...
 * @return              The number of full uint8_ts in the queue.
 ...
 *
 * @param[in] iqp       pointer to an @p InputQueue structure
 * @return              The number of empty uint8_ts in the queue.
 ...
 * @details This function reads a uint8_t value from an input queue. If the queue
 *          is empty then the calling thread is suspended until a uint8_t arrives
 *          in the queue.
 *
 * @param[in] iqp       pointer to an @p InputQueue structure
 ...
 * @details This function writes a uint8_t value to an output queue. If the queue
 *          is full then the calling thread is suspended until there is space
 *          in the queue.
 *
 * @param[in] oqp       pointer to an @p OutputQueue structure
 * @param[in] b         the uint8_t value to be written in the queue
